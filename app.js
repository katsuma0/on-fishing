...
/* park pages live in the sibling on-site app; from the iOS shell the link
   opens in Safari (the old bundled layout no longer exists) */
const SJ_URL='https://katsuma.ca/on-site/';
