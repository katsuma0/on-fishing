# on-fishing for iPhone

A native iOS app around Ontario's fishing zones, seasons and limits. The web app in this repo is bundled in at
...
1. Get the code and open the project:
       ...
       git clone https://github.com/katsuma0/on-fishing.git
       cd on-fishing
       git checkout claude/share    # or main once https://github.com/katsuma0/on-fishing/pull/6 is merged
       open ios/OnFishing.xcodeproj

2. In Xcode, click the blue project icon, pick the "OnFishing" target,
